...
<div class="col-lg-9 mt-2">
    <div class="card">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="needs-validation" novalidate action="proses/proses_input_orderitem.php" method="POST">
                            <input type="text" name="kode_order" value="<?php echo $kode ?>">
                            <input type="text" name="meja" value="<?php echo $meja ?>">
        ...
        <div>
            ...
            <button class="<?php echo(!empty($row['id_bayar']))? "btn btn-secondary disabled" : "btn btn-primary"; ?>" data-bs-toggle="modal" data-bs-target="#bayar"><i class="bi bi-cash-coin"></i> Bayar
            </button>
        </div>
    </div>
</div>
